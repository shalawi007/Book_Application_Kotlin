...
import com.example.bookapplicationkotlin.databinding.FragmentBookUserBinding
...
class BookUserFragment : Fragment {
    ...
    public companion object{
        ...
        //receive data from activity to load data
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //get passed arguments from newInstance()
        val args = arguments
        if(args != null){
    ...
    private fun loadMostViewed(orderBy: String) {
        //init list
        pdfArrayList = ArrayList()
        val ref = FirebaseDatabase.getInstance().getReference("Books")
        ref.orderByChild(orderBy).limitToLast(10) // load ten most
